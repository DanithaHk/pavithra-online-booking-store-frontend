        ...
        <section className="about-section">
            <div className="about-wrapper">
                ...
                <div className="about-right">
                    <h2 className="about-title">About Pravithra Bookstore</h2>
                    <p>
                        Welcome to <strong>Pravithra Online Bookstore</strong> — your one-stop destination for a world of knowledge, stories, and imagination.
                    </p>
                    <p>
